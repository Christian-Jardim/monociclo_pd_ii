...
begin
    ...
    process(id_ex_rt, ex_mem_reg_write, ex_mem_rd, mem_wb_reg_write, mem_wb_rd)
    begin
    ...
    process(id_ex_rs, id_ex_ula_src, ex_mem_reg_write, ex_mem_rd, mem_wb_reg_write, mem_wb_rd)
    begin
